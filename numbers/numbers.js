...
let theScore = (scoreValue / maxValue) * 100
let scorePercentage = theScore.toFixed(2)
...
let stringParsedNumber = parseTheNumber.replace(/[^0-9.]/g, "")
let parsedNumber = parseFloat(stringParsedNumber) // to cnvert it from string to float
