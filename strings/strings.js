...
let lastSixCharacters = getLastSixCharacters.substring(getLastSixCharacters.length, getLastSixCharacters.length-6)
...
testString2 = testString2.replace(testString2,targetString2)
